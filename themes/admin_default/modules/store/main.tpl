		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="{VIEW.link}" target="_blank" title="{VIEW.title}">{VIEW.title}</a><br/> <strong> {LANG.catalog}:</strong>  {VIEW.catalog}</td>
					<td> <strong> {LANG.sdt}:</strong> {VIEW.sdt}<br/><strong> {LANG.dia_chi}:</strong>  {VIEW.dia_chi}  </td>
					
			
					<td> {VIEW.hitstotal} </td>
